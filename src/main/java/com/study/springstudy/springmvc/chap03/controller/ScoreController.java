...
public class ScoreController {
    ...
    public String list(@RequestParam(defaultValue = "num") String sort,
        ...
        System.out.println("[dbg] /score/list: GET!");
    ...
    public String register(ScorePostDTO dto) {
        ...
        // 등록이 완료 되었다면 목록 화면으로 데이터를 전달해서 점수 목록을 보여주고 싶다.
        // 목록처리를 다른 메서드가 하고 있다. -> 중복로직을 작성할 필요는 없다.
    ...
    public String detail(@RequestParam int stuNum,
                         Model model) {
        System.out.println("[dbg] /score/detail: GET!!");
    ...
    public String remove(@RequestParam int stuNum) {
        System.out.println("[dbg] /score/remove: POST!!");
        System.out.println("[dbg] /scorestuNum = " + stuNum);
    ...
    public String modify(@RequestParam int stuNum, Model model) {
        ...
        System.out.println("[dbg] /score/modify: GET!!");
        retrieve(stuNum, model);
    ...
    //진짜 수정 처리 요청
    // Service, Repository 계층과 연계하여 update처리를 진해 주세요.

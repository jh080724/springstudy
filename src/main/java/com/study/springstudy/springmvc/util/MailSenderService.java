...
public class MailSenderService {
    ...
    // 이 메서드를 컨트롤러가 호출할 것임.
    public String joinMail(String email) throws MessagingException { // 컨트롤러로 부터 이메일을 전달 받음.
        int authNum = makeRandomNumber();
        String setFrom = "rose_button@naver.com";  // 발신용 이메일 주소(properties에 있는 값과 동일)
    ...
    private void mailSend(String setFrom, String toMail, String title, String content) throws MessagingException {
        ...
        */
        ...
        // 내용채우기(true를 전송하면 html이 포함되어 있음을 의미)
